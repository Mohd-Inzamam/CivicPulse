...
```// filepath: d:\React\College Mini Project\civicpulse\README.md
...
Screenshots
- Add screenshots to client/public/screenshots and reference them here:
  - /client/public/screenshots/login.png
  - /client/public/screenshots/dashboard.png
  - /client/public/screenshots/report-issue.png
